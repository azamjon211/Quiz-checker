...
<body class="bg-slate-950 min-h-screen text-slate-100">
    ...
    <footer class="relative z-10 mt-24 border-t border-white/5">
        <div class="max-w-6xl mx-auto px-4 py-10 flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            <div class="flex items-center gap-4">
                <a href="tel:+998946088109"
                   class="flex items-center gap-1.5 text-xs text-slate-400 hover:text-indigo-400 transition-colors">
                    <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"/>
                    </svg>
                    +998 94 608 81 09
                </a>
                <a href="https://t.me/PhpCoder_21" target="_blank"
                   class="flex items-center gap-1.5 text-xs text-slate-400 hover:text-sky-400 transition-colors">
